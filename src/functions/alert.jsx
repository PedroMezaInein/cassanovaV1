...
// functions/alert.js (o donde esté)
export function validateAlert22(success, formElement, tipo, enviar) {
// <<<<<<< HEAD
//     if (!formElement) {
//         console.error("❌ El formulario no está disponible (formElement es null).");
//         return;
//     }

//     const elementsInvalid = formElement.getElementsByClassName("is-invalid");

//     if (enviar) {
//         if (elementsInvalid.length === 0) {
//             success({ target: formElement }, tipo);
//         } else {
//             Swal.fire({
//                 title: '¡LO SENTIMOS!',
//                 text: 'Llena todos los campos requeridos',
