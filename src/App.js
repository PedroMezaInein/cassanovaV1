...
const EgresosFormNew = React.lazy(() => import('./pages/Administracion/Egresos/EgresosFormNew') )
...
const ComprasFormNew = React.lazy(() => import('./pages/Proyectos/Compras/ComprasFormNew') )
        ...
        return(
            <div>
                ...
                <Switch>
                    ...
                    <Route path = "/proyectos/compras2/:action" exact component ={ ComprasFormNew } />
                    ...
                    <Route path = "/administracion/egresos2/:action" exact component ={ EgresosFormNew } />
