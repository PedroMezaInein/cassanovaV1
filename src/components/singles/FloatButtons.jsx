    ...
    render() {
        ...
        return (
            <ul className="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-2 mt-4">
                <OverlayTrigger overlay={<Tooltip><span className="font-weight-bold">GUARDAR DATOS <br/>{title}</span></Tooltip>}>
                ...
                </OverlayTrigger>
                {
                    url === formulario.page ?
                        Object.keys(formulario.form).length > 0 ?
                            <OverlayTrigger overlay={<Tooltip><span className="font-weight-bold">RECUPERAR DATOS <br/> GUARDADOS {title}</span></Tooltip>}>
