...
class NewTable extends Component{
    ...
    render = () => {
        const {mostarPalabra,idAuth,addPropio, addExterno,verSugerencias, tableName,ocultar_filtrar,revisar_elementos, mostarPermisos,customtitle, customlabel, customsubtitle,addClick, title, subtitle, abrir_modal, url, filterClick, children, exportar_boton, pendingPaymentClick, hideNew,opciones } = this.props
        return(
                ...
                <Card.Header id  = { `${tableName}-card-header-id` } className = { `${tableName}-card-header-class border-0` }>
                    ...
                    <div className="card-toolbar toolbar-dropdown">
                        ...
                        {    
                              ...
                              {this.setNaviIcon('flaticon-exclamation', 'Sugerencias Recibidas')}
                               </Dropdown.Item>
                               <Dropdown.Item className="text-hover-success dropdown-success" onClick={addPropio} >
                              {this.setNaviIcon('flaticon-add', 'Sugerencia Personal')}
                               </Dropdown.Item>
                                <Dropdown.Item className="text-hover-success dropdown-success" onClick={addExterno} >
                                {this.setNaviIcon('flaticon-add', 'Sugerencia a departamento')} 
                                 </Dropdown.Item></>
                                 :  <> 
                                 <Dropdown.Item className="text-hover-success dropdown-success" onClick={addPropio} >
                                {this.setNaviIcon('flaticon-add', 'Sugerencia Personal')}
                        ...
                        }  
                        {
                                ...
                                {this.setNaviIcon('flaticon2-search-1', `MOSTRAR ${mostarPalabra}`)}
                            </Dropdown.Item>
                        : <></>
                            }
                            {
