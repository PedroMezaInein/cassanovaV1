...
class FloatBtnPresupuesto extends Component {
    render() {
        const { save, saveTempData, generarPDF, pdf, recover, formulario, url } = this.props
        return (
            <ul className="sticky-toolbar nav flex-column pl-2 pr-2 pt-3 pb-2 mt-4">
                <OverlayTrigger rootClose placement="left" overlay={<Tooltip><span className="font-weight-bold">GUARDAR RESUPUESTO</span></Tooltip>}>
                    <li className="nav-item mb-2" data-placement="right">
                        <span className="btn btn-sm btn-icon btn-light-success" onClick={save}>
                ...
                {
                    pdf ?
                        <OverlayTrigger rootClose placement="left" overlay={<Tooltip><span className="font-weight-bold">GUARDAR Y GENERAR RESUPUESTO</span></Tooltip>}>
                            <li className="nav-item mb-2" data-placement="right">
                                <span className="btn btn-sm btn-icon btn-light-primary" onClick={generarPDF}>
                ...
                <OverlayTrigger rootClose placement="left" overlay={<Tooltip><span className="font-weight-bold">GUARDAR TEMPORALMENTE PRESUPUESTO</span></Tooltip>}>
                    <li className="nav-item mb-2" data-placement="right">
                        <span className="btn btn-sm btn-icon btn-bg-light btn-text-info btn-hover-info" onClick={saveTempData}>
                        ...
                        Object.keys(formulario.form).length > 0 ?
                            <OverlayTrigger rootClose placement="left" overlay={<Tooltip><span className="font-weight-bold">RECUPERAR DATOS TEMPORALES</span></Tooltip>}>
                                <li className="nav-item mb-2" title="" data-placement="left">
                                    <span className="btn btn-sm btn-icon btn-bg-light btn-text-dark btn-hover-dark" onClick={recover}>
...
export default FloatBtnPresupuesto