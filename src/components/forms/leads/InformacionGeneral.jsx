            ...
            <>
                <Form>
                    <Row className="mx-0 mb-5">
                        <Col md={lead.estatus? lead.estatus.estatus!=="En espera" ?4:12:4} className={lead.estatus? lead.estatus.estatus!=="En espera" ?"order-1":"order-2":"order-1"}>
                        ...
                        <Col md={lead.estatus? lead.estatus.estatus!=="En espera" ?8:12:8} className={`align-self-center ${lead.estatus? lead.estatus.estatus!=="En espera" ?"order-2":"order-1":"order-2"}`}>
                            <div className="form-group row form-group-marginless mb-2">
                                <div className={lead.estatus? lead.estatus.estatus!=="En espera" ?"col-md-4":"col-md-4":"col-md-4"}>
                            ...
                            {
                                lead.estatus ?
                                    lead.estatus.estatus !== "En espera" ? <div className="separator separator-dashed mt-1 mb-2"></div>
                                        : ""
