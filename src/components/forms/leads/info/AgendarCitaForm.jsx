                                ...
                                <div className="col-md-12">
                                    ...
                                    <div className="form-group row d-flex justify-content-center">
                                        <div className="input-daterange input-group" style={{ width: "auto" }}>
                                            <Form.Control as="select" className="px-1 py-0" style={{ height: "27px" }} value={formAgenda.hora} onChange={onChange} name='hora'>
                                            ...
                                            <Form.Control as="select" className="px-1 py-0" style={{ height: "27px" }} value={formAgenda.minuto} onChange={onChange} name='minuto'>
