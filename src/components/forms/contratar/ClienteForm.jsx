...
import { InputGray, InputNumberGray, Button, InputPhoneGray } from '../../form-components'
                ...
                <div className="form-group row form-group-marginless">
                    <div className="col-md-4">
                        <InputGray
                            ...
                            messageinc="Ingresa el nombre de la empresa o particular."
                        />
                    </div>
                    <div className="col-md-4">
                        <InputGray
                    ...
                    <div className="col-md-4">
                        <InputGray
                            ...
                            messageinc="Ingresa el nombre del contacto."
                        />
                    </div>
                </div>
                ...
                <div className="form-group row form-group-marginless">
                    <div className="col-md-4">
                        <InputGray
                            ...
                            messageinc="Ingresa el puesto del contacto."
                        />
                    </div>
                    <div className="col-md-4">
                        <InputPhoneGray
