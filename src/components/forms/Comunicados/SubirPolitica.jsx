    ...
    const handleSubmit = (e) => {
        ...
        if(validateForm()){
            ...
            try {
                handleClose()
                Swal.fire({
                    title: 'Subiendo politica',
                    text: 'Espere por favor',
                    showConfirmButton: false,
                    timer: 1500,
                })
                apiPostForm('comunicado/politicas/add', data, authUser)
                .then(res => {
                    getinfo()
                    Swal.fire({
                        title: 'Correcto',
                        text: 'La politica se subió correctamente',
                        showConfirmButton: false,
                        timer: 3500,
                    })
                })
        ...
        <div className="kanban-container">
            ...
            {/* <div className="container-modal"> */}
                <div className="position-relative">
                        ...
                        <InputLabel id="demo-simple-select-label">Nombre de la politica</InputLabel>
