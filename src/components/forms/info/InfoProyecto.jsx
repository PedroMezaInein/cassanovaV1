...
class InfoProyecto extends Component {
    ...
    render() {
        ...
        return (
            <div className="container-fluid info-proyecto">
                <div className="">
                    <div className="row mx-0 d-flex justify-content-center align-self-center align-content-center">
                        <div className="col-cards col-md-12 col-lg-12 col-xxl-10">
                            ...
                            <div className="row mx-0 justify-content-center">
                                <div className="col-md-6">
                                    <div className="card-principal text-center border-0">
                                        <div className="oval">
                                            <img className="card-img" src="/images/svg/Proyecto-project.svg" alt="" />
                                        </div>
                                    ...
                                    <div className="card-principal text-center border-0">
                                        <div className="oval">
                                            <img className="card-img" src="/images/svg/Proyecto-costo.svg" alt="" />
                                        </div>
                                        <div className="pt-8 px-0">
                                ...
                                <div className="col-md-6">
                                    <div className="card-principal text-center border-0">
                                        <div className="oval">
                                            <img className="card-img" src="/images/svg/Proyecto-user.svg" alt="" />
                                        </div>
                                    ...
                                    <div className="card-principal text-center border-0">
                                        <div className="oval">
                                            <img className="card-img" src="/images/svg/Proyecto-location.svg" alt="" />
                                        </div>
                                        <div className="pt-8 px-2">
