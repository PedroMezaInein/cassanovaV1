...
import { Modal as ModalCustom } from '../../../components/modals'
import { CalendarDaySwal, InputGray } from '../../form-components'
import PresupuestoDiseñoCRMForm from '../info/PresupuestoDiseñoCRMForm'
...
class CotizacionesDiseño extends Component {
    ...
    render() {
        const { lead, options, formDiseño, onChange, onChangeConceptos, checkButtonSemanas, onChangeCheckboxes, sendPresupuesto,
            onSubmit, formeditado, onClickTab, activeKey, defaultKey, onChangePartidas, at, submitPDF } = this.props
                ...
                <Card className='card card-custom gutter-b'>
                    <Card.Header className="border-0 align-items-center pt-8 pt-md-0">
                        ...
                        <div className="card-toolbar">
                            <DropdownButton menualign="right" title='opciones' className="dropdown-cotizacion">
                                {
                                    activeCotizacion === 'historial' ?
                                        <>
                                            <Dropdown.Item className="new" onClick={() => { this.onClickCotizacion('new') }}>
                                            ...
                                            <Dropdown.Item className="filter" onClick={() => { this.openFormFilter('filter') }}>
                                ...
                                }
                                {
                                    this.showBtnHistorial(lead) ?
                                        <Dropdown.Item className="historial" onClick={() => { this.onClickCotizacion('historial') }}>
