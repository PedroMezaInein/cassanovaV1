...
class EquipoForm extends Component {
    ...
    render() {
        ...
        return (
            <Form id = 'form-equipo'>
                <div className="row form-group-marginless mx-0 my-6 justify-content-center">
                    ...
                    <div className="col-md-12 separator separator-dashed my-5" />
                    <div className="col-md-3">
                    ...
                    <div className="col-md-9 mb-3">
                        <Input requirevalidation = { 0 } formeditado = { formeditado } placeholder = "OBSERVACIONES" as = "textarea" rows = "1"
