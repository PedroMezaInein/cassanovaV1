...
export default function Comentarios(props) {
  ...
  useEffect(() => {
    // Fetch comments data
    apiGet(`requisicion/compras/comentario/${data.id}`, user.access_token)
      .then((res) => {
  ...
  const handleAddComment = () => {
    ...
    apiPostForm('requisicion/compras/comentario', { requisitionId: data.id, comment: newComment }, user.access_token)
      .then((res) => {
