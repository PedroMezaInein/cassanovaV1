                        ...
                        >
                                ...
                                <div className="mx-0 row border-rh-info ribbon ribbon-top">
                                    ...
                                    <div className="mx-0 row">
                                        ...
                                        <div className="col-md-2">
                                            <InputGray withtaglabel={1} withtextlabel={1} withplaceholder={1} withicon={1} withformgroup={0} requirevalidation={1} onChange={onChange} formeditado={formeditado} name="ap_materno"
                                                type="text" value={form.ap_materno} placeholder="APELLIDO PATERNO" iconclass="fas fa-user" messageinc="Incorrecto. Ingresa el nombre." />
                                        </div>
                                        <div className="col-md-2">
                                            <InputGray withtaglabel={1} withtextlabel={1} withplaceholder={1} withicon={1} withformgroup={0} requirevalidation={1} onChange={onChange} formeditado={formeditado} name="ap_paterno"
                                                type="text" value={form.ap_paterno} placeholder="APELLIDO MATERNO" iconclass="fas fa-user" messageinc="Incorrecto. Ingresa el nombre." />
                                        </div>
                                        ...
                                        <div className="col-md-2">
                                            <InputGray withtaglabel={1} withtextlabel={1} withplaceholder={1} withicon={1} requirevalidation={0} formeditado={formeditado} onChange={onChange}
                                                name="matricula" type="text" value={form.matricula} placeholder="Matricula" iconclass="fas fa-hospital-user"  messageinc="Incorrecto. Ej. 01234567891" typeformat="###########"
                                            />
                                        </div>
                                    </div>
                                    <div className="mx-0 row border-rh-info ribbon ribbon-top" style={{ width: "100%" }}>
                                        ...
                                        <div className="form-group row form-group-marginless" style={{ width: "100%" }}>
                                            ...
                                            <div className="col-md-3">
                                                <SelectSearchGray withtaglabel={1} withtextlabel={1}  requirevalidation={0}  customdiv="mb-0" formeditado={formeditado} options={options.organigrama} placeholder="Selecciona el organigrama"
                            ...
                            <div id="wizard-2-content" className="pb-3" data-wizard-type="step-content">
                                <div className="mx-0 row border-rh-info ribbon ribbon-top form-group-marginless">
                                    ...
                                    <div className="col-md-2">
                                        <SelectSearchGray withtaglabel={1} withtextlabel={1} requirevalidation={1} formeditado={formeditado} options={options.registro_patronal ? options.registro_patronal: ''} 
                                        onChange={this.updateRepse} name="id_patronal" value={form.id_patronal} placeholder="Registro Patronal" iconclass={"fas fa-hospital-user"}   messageinc="Incorrecto. Selecciona el registro patronal"                                         
                                        />
                                ...
                                <div className="mx-0 row border-rh-info ribbon ribbon-top form-group-marginless" style={{ width: "100%" }}>
                                    ...
                                    <div className="col-md-2">
                                        <InputNumberGray withtaglabel={1} withtextlabel={1} withplaceholder={1} withicon={1} requirevalidation={0} formeditado={formeditado} onChange={onChange}
                                            name="infonavit" type="text" value={form.infonavit} placeholder="infonavit" iconclass="fas fa-money-check-alt" messageinc="Incorrecto. Ingresa el infonavit ."
                                            thousandseparator={true} prefix={'$'}
                                        />
                                    </div>
                                    <div className="col-md-2">
