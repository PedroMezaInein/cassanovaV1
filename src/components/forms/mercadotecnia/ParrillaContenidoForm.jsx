...
class ParrillaContenidoForm extends Component {
    ...
    render() {
        const { options, form, onChange, onSubmit, formeditado, activeKey, onChangeModalTab, addComentario, evento, ...props } = this.props
        return (
            ...
            >
                <Tab.Container activeKey = { activeKey } >
                    <Nav className="nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x border-0 nav-tabs-line-info mt-3 d-flex justify-content-end">
                                        ...
                                        <div className="form-group row form-group-marginless mt-4">
                                            ...
                                            <div className="col-md-4">
                                                <SelectSearch formeditado = { formeditado } options = { options.socialNetworks }
                                                    ...
                                                    iconclass = "far fa-building" messageinc="Incorrecto. Selecciona la red social"
                                                    />
                                            </div>
                                            <div className="col-md-4">
