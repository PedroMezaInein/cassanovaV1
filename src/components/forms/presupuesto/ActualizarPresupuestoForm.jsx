                        ...
                        <Card.Body className="p-0">
                            <div className="table-responsive">
                                <div className="list list-hover min-w-500px" data-inbox="list">
                                    <div
                                        className="d-flex align-items-start list-item card-spacer-x py-4"
                                        data-inbox="message">
                    ...
                    <Card className="mt-4">
                        ...
                        <Card.Body>
                            <table className="table table-separate table-responsive-sm pt-5">
                                <thead>
                                    <tr>
                                        <th className="check_desc " rowSpan="2">
                                            <div className="mt-2 pb-3 font-size-sm"></div>
                                        </th>
                                        <th className="clave" rowSpan="2">
                                            <div className="mt-2 pb-3 font-size-sm">Clave</div>
                                        </th>
                                        <th className="descripcion" rowSpan="2">
                                            <div className="mt-2 pb-3 font-size-sm">Descripción</div>
                                        </th>
                                        <th rowSpan="2">
                                            <div className="mt-2 pb-3 font-size-sm">Unidad</div>
                                        </th>
                                        <th rowSpan="2">
                                            <div className="mt-2 pb-3 font-size-sm">Costo</div>
                                        </th>
                                        <th rowSpan="2">
                                            <div className="mt-2 pb-3 font-size-sm">Cantidad Preliminar</div>
                                        </th>
                                        <th rowSpan="2">
                                            <div className="mt-2 pb-3 font-size-sm">% Despercicio</div>
                                        </th>
                                        <th rowSpan="2">
                                            <div className="mt-2 pb-3 font-size-sm">Cantidad</div>
                                        </th>
                                        <th rowSpan="2">
                                            <div className="mt-2 pb-3 font-size-sm">Importe</div>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
