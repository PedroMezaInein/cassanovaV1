...
class ActualizarPresupuestoForm extends Component {
    ...
    render() {
        const { options, onChange, onSubmit, formeditado, data, checkButton, form} = this.props
...
export default connect(mapStateToProps, mapDispatchToProps)(ActualizarPresupuestoForm);