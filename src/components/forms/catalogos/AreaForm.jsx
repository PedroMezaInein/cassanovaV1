            ...
            <Form { ... props}>
                ...
                <div className="row mx-0">
                    <div className="col-md-6 mx-center px-2">
                        <Input required name="nombre" value={form.nombre} placeholder="Nombre" onChange={onChange} />
                    </div>
                    <div className="col-md-6 mx-center d-flex px-2 align-items-end">
                        <div className="w-100">
                            <Input name="subarea" value={form.subarea} placeholder="Subarea" onChange={onChange} />
                        </div>
