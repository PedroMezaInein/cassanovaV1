                        ...
                        <div className="d-flex">
                            ...
                            <div className="flex-grow-1">
                                <div className="d-flex align-items-start justify-content-between flex-wrap mt-2">
                                    ...
                                    <div className="mb-2">
                                        <span className="label label-lg bg- label-inline font-weight-bold py-2">En espera</span>
                                    </div>
                                </div>
                        ...
                        <div className="col-md-5 px-0">
                            <div className="d-flex align-items-center mb-3">
                                ...
                                <div className="d-flex flex-column font-weight-bold">
                                    <div className="font-size-h6 text-dark-75 font-weight-bolder">INSTALACIONES ESPECIALES DE PROTECCIÓN CIVIL</div>
                            ...
                            <div className="d-flex align-items-center mb-4">
                                ...
                                <div className="d-flex flex-column font-weight-bold">
                                    <div className="font-size-h6 text-dark-75 font-weight-bolder">VICIOS OCULTOS</div>
