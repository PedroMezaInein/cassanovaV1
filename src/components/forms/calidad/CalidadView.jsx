                            ...
                            <div className="d-flex align-items-center justify-content-between flex-wrap mt-2">
                                <div className="mr-3">
                                    ...
                                    <div className="d-flex flex-wrap my-2">
                                        ...
                                        {/* <div className="text-muted font-weight-bold mr-lg-5 mr-5 mb-lg-0 mb-2 mt-2">
                                            <i className="far fa-calendar-alt icon-md mr-2"></i>
                                                09/07/2020 - FECHA
                                        </div> */}
                                    </div>
                                </div>
                    ...
                    {/* <div className="d-flex align-items-center flex-wrap">
                        <div className="d-flex align-items-center flex-lg-fill mr-5 my-1">
                            ...
                            <div className="d-flex flex-column text-dark-75">
                                ...
                                <span className="font-weight-bolder font-size-h5">
                                    <span className="text-dark-50 font-weight-bold">$</span>145,200</span>
                            </div>
                        </div>
                        ...
                        <div className="d-flex align-items-center flex-lg-fill mr-5 my-1">
                            ...
                            <div className="d-flex flex-column text-dark-75">
                                ...
                                <span className="font-weight-bolder font-size-h5">
                                    <span className="text-dark-50 font-weight-bold">$</span>274,230</span>
                            </div>
                        </div>
                        ...
                        <div className="d-flex align-items-center flex-lg-fill mr-5 my-1">
                            ...
                            <div className="d-flex flex-column text-dark-75">
                                ...
                                <span className="font-weight-bolder font-size-h5">
                                    <span className="text-dark-50 font-weight-bold">$</span>461,120</span>
                            </div>
                        </div>
                        ...
                        <div className="d-flex align-items-center flex-lg-fill mr-5 my-1">
                            ...
                            <div className="d-flex flex-column flex-lg-fill">
                                <span className="text-dark-75 font-weight-bolder font-size-sm">45 Tasks</span>
                                <a className="text-primary font-weight-bolder">View</a>
                            </div>
                        </div>
                        ...
                        <div className="d-flex align-items-center flex-lg-fill mr-5 my-1">
                            ...
                            <div className="d-flex flex-column">
                                <span className="text-dark-75 font-weight-bolder font-size-sm">968 Comments</span>
                                <a className="text-primary font-weight-bolder">View</a>
                            </div>
                        </div>
                    </div> */}
