...
export default class FormNuevoTicket extends Component {
    ...
    updateTipoTrabajo = value => {
        const { onChange } = this.props
        onChange({ target: { value: value, name: 'tipo_trabajo' } })
    }
    render() {
            ...
            <>
                <Form id="form-nuevo-ticket"
                    onSubmit={
                        (e) => {
                            e.preventDefault();
                            validateAlert(onSubmit, e, 'form-nuevo-ticket')
                        }
                    } >
                    <div className="form-group row form-group-marginless pt-4 justify-content-md-center">
                        ...
                        <div className="col-md-6">
                            <SelectSearchGray
                                ...
                                onChange={this.updateTipoTrabajo}
                    ...
                    <div className="form-group row form-group-marginless">
                        <div className="col-md-12">
                            <InputGray withtaglabel={1} withtextlabel={1} withplaceholder={1} withicon={0} withformgroup={0}
                                requirevalidation={1} as="textarea" placeholder="DESCRIPCIÓN DEL PROBLEMA"
                                rows="2" value={form.descripcion} name="descripcion" onChange={onChange}
