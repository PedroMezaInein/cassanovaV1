                        ...
                        <div className="row row-paddingless mb-4">
                            {
                                data.proveedor ?
                                    <div className="col-md-3">
                                        <div className="d-flex align-items-center align-items-center mr-2">
                                            <div className="symbol symbol-35 symbol-light-primary mr-4 flex-shrink-0">
                                                <div className="symbol-label">
                                                    <span className="svg-icon svg-icon-lg svg-icon-primary">
                                ...
                                data.adjunto ?
                                    <div className="col-md-3">
                                        <div className="d-flex justify-content-start align-items-center mr-2">
                                            ...
                                            <div>
                                                <a rel="noopener noreferrer"  href={data.adjunto.url} target="_blank" className="font-size-h6 text-dark-75 font-weight-bolder text-hover-info">{data.adjunto.name}</a>
