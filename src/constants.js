...
export const COLORES_GRAFICAS_MESES = [ '#F64E60', '#EC407A', '#AB47BC', '#5C6BC0', '#42A5F5', '#26C6DA', 
...
//Expresiones Regulares
    ...
    export const DATE ='(^(((0[1-9]|1[0-9]|2[0-8])[](0[1-9]|1[012]))|((29|30|31)[](0[13578]|1[02]))|((29|30)[](0[4,6,9]|11)))[](19|[2-9][0-9])$)|(^29[]02[](19|[2-9][0-9])(00|04|08|12|16|20|24|28|32|36|40|44|48|52|56|60|64|68|72|76|80|84|88|92|96)$)'
    export const TEL = '^[0-9]{10}$'
    export const EMAIL = '^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:[a-zA-Z0-9-]+)*$'
    // export const EMAIL='/^(?:[^<>()[\].,;:\s@"]+(\.[^<>()[\].,;:\s@"]+)*|"[^\n"]+")@(?:[^<>()[\].,;:\s@"]+\.)+[^<>()[\]\.,;:\s@"]{2,63}$/i'
    export const NSS = '^({2})({2})({2}){5}$'
    export const CURP = '/^[a-z]{4}{6}[HM][a-z]{5}{2}$/i'
