...
class NotificacionesCorreos extends Component {
    ...
    render() {
        const { options, form, showInput } = this.state
        return (
                        ...
                        <Tab.Pane eventKey="2">
                            ...
                            <div className="p-12">
                                <div className="row">
                                    ...
                                    {/* style={{ backgroundPosition:'right top', backgroundSize:'20% auto', backgroundImage: "url('/images/svg/shapes/abstract-1.svg')" }} */}
