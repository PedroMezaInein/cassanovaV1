            ...
            <Layout { ...this.props}>
                    ...
                    <div className="d-flex flex-row-fluid bgi-size-cover bgi-position-center min-h-350px mb-4 d-flex justify-content-center align-items-center" style ={ { backgroundImage: "url('/proyecto.jpg')", margin:"-25px" } }>
                        <div class="container">
                            <div class="d-flex align-items-stretch text-center flex-column py-40">
                                {/*<h2 class="text-dark font-weight-bolder mb-12"></h2>*/}
										...
										<div class="card-body">
											<div class="d-flex align-items-center ">
												...
												<div class="d-flex flex-column">
													<a  class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">PROYECTO</a>
													<div class="text-dark-75">CENTAURO - SANTA FE - OBRA</div>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="card card-custom wave wave-animate-slow wave-danger mb-8 mb-lg-0">
										<div class="card-body">
											<div class="d-flex align-items-center">
												...
												<div class="d-flex flex-column">
													<a class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">CONTACTO</a>
													<div class="text-dark-75">PAULA GARAVITO</div>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="card card-custom wave wave-animate-slow wave-success mb-8 mb-lg-0">
										<div class="card-body">
											<div class="d-flex align-items-center">
												...
												<div class="d-flex flex-column">
													<a class="text-dark text-hover-primary font-weight-bold font-size-h4 mb-3">PERIODO</a>
													<div class="text-dark-75">11/04/2019 - 06/06/2019</div>
												</div>
											</div>
										</div>
									</div>
                ...
                <div class="col-md-12">
							<div class="card">
								<div class="card-body">
									<div class="p-6">
										<h2 class="text-dark mb-8 pb-4">Adjuntos del proyecto</h2>
										<div class="row">
											<div class="col-lg-3">
												<ul class="navi navi-link-rounded navi-accent navi-hover flex-column mb-8 mb-lg-0" role="tablist">
													<li class="navi-item mb-2">
														<a class="navi-link" data-toggle="tab">
															<span class="navi-text text-dark-50 font-size-h5 font-weight-bold">Inicio y planeación</span>
														</a>
													</li>
													<li class="navi-item mb-2">
														<a class="navi-link active" data-toggle="tab">
															<span class="navi-text text-dark font-size-h5 font-weight-bold">Ejecución de obra</span>
														</a>
													</li>
													<li class="navi-item mb-2">
														<a class="navi-link" data-toggle="tab">
															<span class="navi-text text-dark-50 font-size-h5 font-weight-bold">Entrega</span>
														</a>
													</li>
													<li class="navi-item mb-2">
														<a class="navi-link" data-toggle="tab">
															<span class="navi-text text-dark-50 font-size-h5 font-weight-bold">Mantenimiento</span>
														</a>
													</li>
												</ul>
											</div>
