...
export default function Venta(props) { 
    ...
    const handleSend = () => {
        ...
        if (validateForm()) {
            ...
            try {
                apiPostForm('solicitud-venta', data, auth.access_token).then(
                    (response) => {
                        resetForm()
                        Swal.close()
    ...
    return (
        <>
            ...
            <Accordion >
                ...
                >
                    <Typography className='proyect-Subtitulo'>1. Solicitar Venta</Typography>
                </AccordionSummary>
                <AccordionDetails>
                    ...
                    <div className={Style.container}>
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                >
                                    {form.area_id !== '' ?
                                        opciones.areasVentas.find(item => item.value === form.area_id).subareas.map(item => {
                ...
                <AccordionDetails>
                    <div className={Style.containerFile}>
                        ...
                        <div className="col-md-12 text-center">
                            <label className="col-form-label my-2 font-weight-bolder">Adjunto</label>
                            <ItemSlider
