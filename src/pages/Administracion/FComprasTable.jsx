...
export default function FacturasTable(props) { 
    ...
    const deleteEgresoAxios = (id) => {
        apiDelete(`facturas/compras/${id}`, auth).then(
            (response) => {
                Swal.fire(
                    '¡Eliminado!',
    ...
    const columns = [
        ...
        { nombre: 'Compra', identificador: 'id', stringSearch: false },
    ...
    const cancelaFactura = (id) => {
        apiDelete(`facturas/facturacancelacompra/${id}`, auth).then(
            (response) => {
                Swal.fire(
                    '¡Cancelado!',
    ...
    const  exportEgresosAxios = () => {
        ...
        apiPostFormResponseBlob(`facturas/exportcompras`,{ columnas: form },  auth).then(
            (response) => {
            ...
            <div>
                ...
                title={
                    <React.Fragment >                 
                        ...
                        {"A Favor: " + ( resul2).toLocaleString('es-MX', {style: 'currency', currency: 'MXN',minimumFractionDigits: 2,maximumFractionDigits: 2,}) }
    ...
    return (
        <>
            ...
            {
                modal.filtrar.data &&
                <Modal size="lg" title={"Filtrar compras"} show={modal.filtrar?.show} handleClose={e => handleClose('filtrar')} >
