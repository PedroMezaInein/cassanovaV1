...
import CarruselAdjuntosCompras from './CarruselAdjuntos';
...
import Tabs from '@material-ui/core/Tabs';
import Tab from '@material-ui/core/Tab';
import FacturasCompras from './Facturas'
...
export default function AdjuntosCompras(props) {
    ...
    const getAdjuntos = () => {
        try {
            apiGet(`v2/administracion/egresos/adjuntos/${data}`, authUser).then((res) => {
                const { facturas_pdf, pagos, presupuestos } = res.data.egreso;
    ...
    const handleSubmit = async () => {
        ...
        try {
            for (const file of form[activeTab]) {
                ...
                await apiPostForm(`v2/administracion/egresos/${props.data}/archivos/s3`, data, authUser);
        ...
        <Box>   
            ...
            <div className={classes.root}>
                ...
                <TabPanel value={value} index={0}>
                    <FacturasCompras opcionesData={opcionesData} reload={reload} activeTab={activeTab} egreso={data} />
