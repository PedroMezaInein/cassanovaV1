...
export default function CrearCompras(props) {
    ...
    const {  handleClose, reload, data } = props
    ...
    const [form, setForm] = useState({
        ...
        partida: data.partidas ? data.partidas.id : '',
        leadId: "",
        nombre: "",
        numCuenta: "",
        cliente: data.cliente ? data.cliente.id : '',
        cliente_nombre:data.cliente ? data.cliente.nombre : '',
        rfc:  data.cliente ? data.cliente.rfc : '',
        proyecto: '',
        razonSocial: '',
                            ...
                            <div className="container">
                                ...
                                <div className= "col-md-4">
                                {
                                    ...
                                    <div className="col-md-4">
                                        ...
                                        <Select
                                            value={form.cuenta || ''} // Asegúrate de que el valor no sea null o undefined
                                            name="cuenta"
                                            onChange={handleChange}
                                        ...
                                        >
                                            ...
                                            {
                                                empresas
                                                    .filter((empresa) => empresa.id === form.empresa) // Filtra la empresa seleccionada
                                                    .flatMap((empresa) => empresa.cuentas) // Obtén las cuentas de esa empresa
                                                    .map((cuenta) => (
