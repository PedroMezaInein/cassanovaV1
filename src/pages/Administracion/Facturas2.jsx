...
import { apiOptions,apiPutForm, catchErrors, apiDelete, apiPostFormResponseBlob, apiPostForm } from './../../functions/api';
...
export default function FacturaTable(props) { 
    ...
    const  exportEgresosAxios = () => {
        ...
        apiPostFormResponseBlob(`facturas/exportfacturasreceptor`,{ columnas: form },  auth).then(
            (response) => {
            ...
            if (name === 'factura') {
                ...
                if (extension.toUpperCase() === 'XML') {
                    ...
                    reader.onload = async (e) => {
                        ...
                        let auxEmpresa = ''
                        // opcionesData.empresas.find(function (element, index) {
                        ...
                        let auxCliente
                        // // if (key === 'ventas') { 
                        //     auxCliente = opcionesData.clientes.find((element) => {
                        ...
                        // } else {
                        //     // if (key === 'ventas') { 
                        //         createAlert('NO EXISTE EL CLIENTE', '¿LO QUIERES CREAR?')
                        //     // } else {
