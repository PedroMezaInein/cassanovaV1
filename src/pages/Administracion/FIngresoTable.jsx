...
export default function FIngresoTable(props) { 
    ...
    const deleteEgresoAxios = (id) => {
        apiDelete(`facturas/ingreso/${id}`, auth).then(
            (response) => {
                Swal.fire(
                    '¡Eliminado!',
    ...
    const columns = [
        ...
        { nombre: 'Ingreso', identificador: 'id', stringSearch: false },
    ...
    const cancelaFactura = (id) => {
        apiDelete(`facturas/facturacancelaingreso/${id}`, auth).then(
            (response) => {
                Swal.fire(
                    '¡Cancelado!',
    ...
    const  exportEgresosAxios = () => {
        ...
        apiPostFormResponseBlob(`facturas/exportingreso`,{ columnas: form },  auth).then(
            (response) => {
    ...
    return (
        <>
            ...
            {
                modal.filtrar.data &&
                <Modal size="lg" title={"Filtrar ingreso"} show={modal.filtrar?.show} handleClose={e => handleClose('filtrar')} >
