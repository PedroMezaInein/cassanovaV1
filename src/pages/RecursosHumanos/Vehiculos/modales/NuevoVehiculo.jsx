...
export default function NuevoVehiculo(props) {
    ...
    const handleSubmmit = (e) => { 
        ...
        if (validate()) {
            Swal.fire({
                ...
                text: "¿Estas seguro de crear este vehiculo?",
                icon: 'question',
                ...
                if (result.isConfirmed) {
                    try {
                        ...
                        apiPostForm('vehiculos', form, authUser.access_token)
                            .then(res => {
                                Swal.close()
                                Swal.fire({
                                    title: 'Exito',
        ...
        <>
            ...
            <Accordion>
                ...
                <AccordionDetails>
                    <div className={Style.container}>
                        <div>
                            <div>
                                <InputLabel id="poliza">Numero de Póliza</InputLabel>
                                <TextField
                                    name="poliza"
                                    value={form.poliza}
                                    onChange={handleChange}
                            ...
                            <div>
                                <InputLabel id="fecha_poliza">Fecha de Póliza</InputLabel>
            ...
            <div className="row justify-content-end">
                <div className="col-md-4">
                    <button className={Style.sendButton} type="submit" onClick={handleSubmmit}>Crear</button>
                </div>    
            </div>
