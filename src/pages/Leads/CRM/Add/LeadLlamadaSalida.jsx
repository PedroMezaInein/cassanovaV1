    ...
    updateMessages2 = (name, value) => {
        ...
        switch (name) {
            case 'name':
                ...
                return <><div className="bg-light-pink text-pink font-weight-bold py-2 px-4 font-size-lg mb-3 text-justify">Mucho gusto <span className="font-weight-boldest">{form.name.split(" ", 1)}</span>, recibimos exitosamente su información a través de nuestro sitio web. Me pongo en contacto con usted a relación del servicio que seleccionó de <span className="font-weight-boldest">{this.servicio(lead.servicios)}</span> {this.servicio(lead.servicios)==='Diseño de proyectos para el sector salud'?'.':'para el sector salud.'}</div><div className="bg-light-primary text-primary font-weight-bold py-2 px-4 font-size-lg text-justify">Excelente, puede indicarme <span className="font-weight-boldest">¿Qué tipo de proyecto es?</span></div></>;
                } else if (lead.empresa.name === 'INEIN') {
                    return <><div className="bg-light-pink text-pink font-weight-bold py-2 px-4 font-size-lg mb-3 text-justify">Mucho gusto <span className="font-weight-boldest">{form.name.split(" ", 1)}</span>, recibimos exitosamente su información a través de nuestro sitio web. Me pongo en contacto en relación del servicio que seleccionaste de <span className="font-weight-boldest">{this.servicio(lead.servicios)}.</span></div><div className="bg-light-primary text-primary font-weight-bold py-2 px-4 font-size-lg text-justify">¡EXCELENTE! TE AGRADEZCO QUE NOS TOMES EN CUENTA PARA TU PROYECTO, PUEDES INDICARME <span className="font-weight-boldest">¿Qué tipo de proyecto es?</span></div></>;
                }
                break;
            case 'tipoProyecto':
            ...
            case 'obra':
                if (lead.empresa.name === 'INFRAESTRUCTURA MÉDICA') {
                    ...
                    return<><div className="bg-light-primary text-primary font-weight-bold py-2 px-4 font-size-lg text-justify mb-3">Me gustaría conocer más detalles específicos acerca su proyecto <span className="font-weight-boldest">por lo que le solicito me pueda corroborar su correo electrónico </span> para hacerle llegar un cuestionario. Su correo es: <span className="font-weight-boldest">{lead.email}</span></div><div className="bg-light-pink text-pink font-weight-bold py-2 px-4 font-size-lg mb-3 text-justify">Gracias, en unos minutos le <span className="font-weight-boldest">estaré enviado dicho cuestionario a su correo y además le anexare un documento que será útil para usted </span>, en él se describe detalladamente cada servicio que podemos brindarle.</div><div className="bg-light-primary text-primary font-weight-bold py-2 px-4 font-size-lg mb-3 text-justify">Una vez que me haga llegar su información, la analizare y <span className="font-weight-boldest">posteriormente me estaré comunicado con usted.</span></div><div className="bg-light-pink text-pink font-weight-bold py-2 px-4 font-size-lg text-justify">Gracias por contactarnos, que tenga un excelente día.</div></>;
                    }
                }
                else if (lead.empresa.name === 'INEIN') {
                    if(lead.email===null){
                        ...
                        return <><div className="bg-light-primary text-primary font-weight-bold py-2 px-4 font-size-lg text-justify mb-3">Me gustaría conocer más detalles de tu proyecto <span className="font-weight-boldest">¿Me podrías corroborar tu correo electrónico?</span>&nbsp;para hacerte llegar un cuestionario. Tu correo es: <span className="font-weight-boldest">{lead.email}</span></div><div className="bg-light-pink text-pink font-weight-bold py-2 px-4 font-size-lg mb-3 text-justify">En unos minutos te hare<span className="font-weight-boldest"> llegar a tu correo un cuestionario</span>, te pido nos apoyes en constarlo, para que una vez que yo lo reciba pueda evaluar tu proyecto, ¿De acuerdo?.</div><div className="bg-light-primary text-primary font-weight-bold py-2 px-4 font-size-lg mb-3 text-justify">¿Existiría algo mas en lo que te pueda ayudar antes de finalizar esta llamada?</div><div className="bg-light-pink text-pink font-weight-bold py-2 px-4 font-size-lg text-justify">Muy bien <span className="font-weight-boldest">{form.name.split(" ", 1)}</span>, en un momento te hago el envio del cuestionario. Que tengas un excelente día.</div></>;
                }
            }
                break;
            case 'email':
                if (lead.empresa.name === 'INFRAESTRUCTURA MÉDICA') {
                    ...
                    return <><div className="bg-light-primary text-primary font-weight-bold py-2 px-4 font-size-lg mb-3 text-justify">En unos minutos te hare<span className="font-weight-boldest"> llegar a tu correo un cuestionario</span>, te pido nos apoyes en constarlo, para que una vez que yo lo reciba pueda evaluar tu proyecto, ¿De acuerdo?.</div><div className="bg-light-pink text-pink font-weight-bold py-2 px-4 font-size-lg mb-3 text-justify">¿Existiría algo mas en lo que te pueda ayudar antes de finalizar esta llamada?</div><div className="bg-light-primary text-primary font-weight-bold py-2 px-4 font-size-lg text-justify">Muy bien <span className="font-weight-boldest">{form.name.split(" ", 1)}</span>, en un momento te hago el envio del cuestionario. Que tengas un excelente día.</div></>;
                }
                break;
            default:
                return <></>
            ...
            <Layout active='leads' {...this.props} >
                <div className="card-custom card-stretch gutter-b py-2 card">
                    ...
                    <div className="card-body pt-0">
                        ...
                        <><div className="bg-light-primary text-primary font-weight-bold py-2 px-4 font-size-lg mb-3 text-justify">Buen día mi nombre es {usuario}, asesora comercial en <span className="font-weight-boldest">IM {lead.empresa.name}</span>. {lead.nombre==='SIN ESPECIFICAR'? '¿Con quién tengo el gusto ':'¿Tengo el gusto con '}<span className="font-weight-boldest">{lead.nombre==='SIN ESPECIFICAR'?'':lead.nombre}</span>?</div><div className="bg-light-pink text-pink font-weight-bold py-2 px-4 font-size-lg mb-3 text-justify">Mucho gusto <span className="font-weight-boldest">{lead.nombre.split(" ", 1)}</span>, recibimos exitosamente su información a través de nuestro sitio web. Me pongo en contacto con usted a relación del servicio que seleccionó de <span className="font-weight-boldest">{this.servicio(lead.servicios)}</span> {this.servicio(lead.servicios)==='Diseño de proyectos para el sector salud'?'.':'para el sector salud.'}</div><div className="bg-light-primary text-primary font-weight-bold py-2 px-4 font-size-lg text-justify">Excelente, puede indicarme <span className="font-weight-boldest">¿Qué tipo de proyecto es?</span></div></>
                                        : lead.empresa.name === 'INEIN' ?
                                            <><div className="bg-light-primary text-primary font-weight-bold py-2 px-4 font-size-lg mb-3 text-justify">Buen día mi nombre es {usuario}, asesora comercial en <span className="font-weight-boldest">Infraestructura e Interiores</span>. {lead.nombre==='SIN ESPECIFICAR'? '¿Con quién tengo el gusto ':'¿Tengo el gusto con '}<span className="font-weight-boldest">{lead.nombre==='SIN ESPECIFICAR'?'':lead.nombre}</span>?</div><div className="bg-light-pink text-pink font-weight-bold py-2 px-4 font-size-lg mb-3 text-justify">Mucho gusto <span className="font-weight-boldest">{lead.nombre.split(" ", 1)}</span>, recibimos exitosamente su información a través de nuestro sitio web. Me pongo en contacto a relación del servicio que seleccionaste de <span className="font-weight-boldest">{this.servicio(lead.servicios)}</span>.</div><div className="bg-light-primary text-primary font-weight-bold py-2 px-4 font-size-lg text-justify">¡EXCELENTE! TE AGRADEZCO QUE NOS TOMES EN CUENTA PARA TU PROYECTO, PUEDES INDICARME <span className="font-weight-boldest">¿Qué tipo de proyecto es?</span></div></>
                                            : ''
                                    : ''
                                : messages
                        }
